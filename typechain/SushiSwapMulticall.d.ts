...
interface SushiSwapMulticallInterface extends ethers.utils.Interface {
  functions: {
...
export class SushiSwapMulticall extends BaseContract {
  ...
  interface: SushiSwapMulticallInterface;
